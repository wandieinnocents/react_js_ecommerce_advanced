...
const CategoryShowCase = () => {
  ...
  const filterItems = catetegoryItem => {
    const updateIetms = ProductData.filter(currentElement => {
      return currentElement.cate === catetegoryItem;
    });

    setItems(updateIetms);
  };
  ...
  return (
    <div className="course-section style-3 padding-tb ">
      ...
      <div className="container">
        ...
        {/* section body show products filtered */}
